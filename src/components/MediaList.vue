...
// const curCover = ref<boolean>(false)
// const newUrl = ""
// const newTitle = ""
  ...
  <!-- <div class="medialist">
    ...
    <div v-if="mode == 'edit'">
      <form @submit.prevent="addMedia">
        ...
        <div class="media-list">
          ...
          <div
            v-for="(media, index) in curValue"
            class="media-item"
          >
            <div class="media-slot">
              <figure class="thumbnail-wrapper">
                <div class="media-remove"><button
                    type="button"
                    class="button is-small is-danger"
                    :data-index="index"
                    @click.capture="removeMedia"
                  ><span class="icon is-small"><i class="fa fa-trash"></i></span></button></div>
                <label class="media-cover small">Couverture <input
                    class="radio"
                    type="radio"
                    name="curCover"
                    :data-index="index"
                    :checked="index == curCover"
                    @click="coverSelect"
                  ></label>
                <img
                  v-if="media.url && media.validUrl"
              ...
              <div class="media-url"><input
                  type="url"
                  class="input is-small media-url"
                  v-model="media.url"
                  :data-index="index"
                  @input="validateUrl"
                  placeholder="URL"
            ...
            <div class="media-title"><input
                ...
                required
              ></div>
            <div class="media-description"><textarea
                v-model="media.description"
                class="input is-small"
                style="resize:none;"
                @change="update"
              >{{ media.description }}</textarea></div>
          </div>
          ...
          <div class="media-new-item">
            ...
            <div class="media-description"><textarea
              ...
              >{{ newDescription }}</textarea></div>
            <div class="media-add has-text-right"><button
                type="submit"
                class="button is-small is-primary is-fullwidth"
                :disabled="!canAddMedia"
              ><span class="icon is-small"><i class="fa fa-plus"></i></span><span>Ajouter</span></button>
            </div>
          </div>
    ...
    <div v-if="mode == 'show'">
      ...
      >
        <div
          v-if="skipCover"
          v-for="media in mediasLessCover"
          class="media-item"
        >
          <figure>
            <a
